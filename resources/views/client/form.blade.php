                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="input-group">
                            ...
                            <input name="telefone_contato" type="text" class="form-control" data-inputmask='"mask": "(99) 9999-99999"' data-mask placeholder="Telefone Contato" value="{{ old('telefone_contato') }}">
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
                            <input name="telefone_cobranca" type="text" class="form-control" data-inputmask='"mask": "(99) 9999-99999"' data-mask placeholder="Telefone Cobrança" value="{{ old('telefone_cobranca') }}">
                        </div>
                    </div>
                </div>
            </div><!-- /.box-body -->
